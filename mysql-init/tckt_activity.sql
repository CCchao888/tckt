...
MySQL - 8.2.0 : Database - tckt_activity
*********************************************************************
*/
...
CREATE DATABASE IF NOT EXISTS `tckt_activity` DEFAULT CHARACTER SET utf8mb3;
...
insert  into `coupon_info`(`id`,`coupon_type`,`coupon_name`,`amount`,`condition_amount`,`start_time`,`end_time`,`range_type`,`rule_desc`,`publish_count`,`per_limit`,`use_count`,`receive_count`,`expire_time`,`publish_status`,`create_time`,`update_time`,`is_deleted`) values (1,1,'双十一新用户注册赠送100元卷','100.00','0.00','2023-06-17','2023-07-28',2,'双十一新用户注册赠送100元卷，全程通用，没有限制',100,1,0,3,'2023-07-03 00:00:00',1,'2023-11-06 18:29:14','2023-11-12 08:30:39',0),(2,1,'双十一推荐课程并购买600福利卷','600.00','0.00','2023-08-23','2023-10-26',2,'双十一推荐课程，新用户购买并支付，赠送推荐人600福利卷，全程通用，没有限制',100,1,0,4,'2024-08-26 00:00:00',1,'2023-11-17 11:35:56','2023-11-12 08:31:37',0),(3,2,'国庆新用户注册赠送100元卷','100.00','0.00','2023-09-27','2023-10-31',1,'国庆新用户注册赠送100元卷，全程通用，没有限制',100,1,0,4,'2023-12-07 00:00:00',1,'2023-10-28 06:14:38','2023-11-12 08:31:10',0),(4,1,'国庆推荐课程并购买500福利卷','500.00','0.00','2023-09-14','2023-09-29',1,'双十一推荐课程，新用户购买并支付，赠送推荐人500福利卷，全程通用，没有限制',100,1,0,25,'2023-09-30 00:00:00',1,'2023-11-23 06:50:17','2023-11-12 08:31:16',0),(5,1,'test100','0.00','0.00','2023-11-10','2023-11-23',1,'',100,1,0,0,'2023-12-27 00:00:00',0,'2023-11-10 15:59:32','2023-11-10 15:59:32',0);
