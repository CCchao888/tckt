...
MySQL - 8.2.0 : Database - tckt_order
*********************************************************************
*/
...
CREATE DATABASE IF NOT EXISTS `tckt_order` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
