...
import me.thinkchao.tckt.utils.HttpClientUtils;
 ...
 * Author:chao
 * Date:2023-11-18
 * Description: 参数中的商户id等信息，只有正式公众号中才能使用，测试号没法使用微信支付功能
 */
@Service
public class WXPayServiceImpl implements WXPayService {
    ...
    public Map<String, String> createJsapi(String orderNo) {
        try {
            ...
            paramMap.put("notify_url", "http://tckt.free.idcfengye.com/api/order/wxPay/notify");
